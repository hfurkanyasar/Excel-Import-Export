...
namespace ExcelImportExport.UI.AppData2TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([LastName], [FirstName], [Title], [TitleOfCourtesy], [BirthDate], [HireDate], [Address], [City], [Region], [PostalCode], [Country], [HomePhone], [Extension], [Photo], [Notes], [ReportsTo], [PhotoPath], [AktifMi]) VALUES (@LastName, @FirstName, @Title, @TitleOfCourtesy, @BirthDate, @HireDate, @Address, @City, @Region, @PostalCode, @Country, @HomePhone, @Extension, @Photo, @Notes, @ReportsTo, @PhotoPath, @AktifMi);
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath, AktifMi FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [T" +
                ...
                "tsTo, [PhotoPath] = @PhotoPath, [AktifMi] = @AktifMi WHERE (([EmployeeID] = @Ori" +
                ...
                "R ([Extension] = @Original_Extension)) AND ((@IsNull_ReportsTo = 1 AND [ReportsT" +
                "o] IS NULL) OR ([ReportsTo] = @Original_ReportsTo)) AND ((@IsNull_PhotoPath = 1 " +
                "AND [PhotoPath] IS NULL) OR ([PhotoPath] = @Original_PhotoPath)) AND ([AktifMi] " +
                ...
                "ne, Extension, Photo, Notes, ReportsTo, PhotoPath, AktifMi FROM Employees WHERE " +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDa" +
                ...
                "es, ReportsTo, PhotoPath, AktifMi FROM dbo.Employees";
        ...
        public virtual int Fill(AppData2.EmployeesDataTable dataTable) {
        ...
        public virtual AppData2.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AppData2.EmployeesDataTable dataTable = new AppData2.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AppData2.EmployeesDataTable dataTable) {
        ...
        public virtual int Insert(
            ...
            this.Adapter.InsertCommand.Parameters[17].Value = ((bool)(AktifMi));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[17].Value = ((bool)(AktifMi));
            ...
            this.Adapter.UpdateCommand.Parameters[47].Value = ((bool)(Original_AktifMi));
