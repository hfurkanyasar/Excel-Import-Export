...
namespace ExcelImportExport.UI {
    ...
    public partial class NORTHWNDDataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string LastName, string FirstName, string Title, string TitleOfCourtesy, System.DateTime BirthDate, System.DateTime HireDate, string Address, string City, string Region, string PostalCode, string Country, string HomePhone, string Extension, string Notes, EmployeesRow parentEmployeesRowByFK_Employees_Employees) {
...
namespace ExcelImportExport.UI.NORTHWNDDataSet1TableAdapters {
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Notes, ReportsTo FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [Title] " +
                ...
                "on] = @Extension, [Notes] = @Notes, [ReportsTo] = @ReportsTo WHERE (([EmployeeID" +
                ...
                " = @Original_Title)) AND ((@IsNull_TitleOfCourtesy = 1 AND [TitleOfCourtesy] IS " +
                "NULL) OR ([TitleOfCourtesy] = @Original_TitleOfCourtesy)) AND ((@IsNull_BirthDat" +
                "e = 1 AND [BirthDate] IS NULL) OR ([BirthDate] = @Original_BirthDate)) AND ((@Is" +
                "Null_HireDate = 1 AND [HireDate] IS NULL) OR ([HireDate] = @Original_HireDate)) " +
                ...
                "D ((@IsNull_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)) A" +
                "ND ((@IsNull_PostalCode = 1 AND [PostalCode] IS NULL) OR ([PostalCode] = @Origin" +
                "al_PostalCode)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] =" +
                " @Original_Country)) AND ((@IsNull_HomePhone = 1 AND [HomePhone] IS NULL) OR ([H" +
                "omePhone] = @Original_HomePhone)) AND ((@IsNull_Extension = 1 AND [Extension] IS" +
                " NULL) OR ([Extension] = @Original_Extension)) AND ((@IsNull_ReportsTo = 1 AND [" +
                "ReportsTo] IS NULL) OR ([ReportsTo] = @Original_ReportsTo)));\r\nSELECT EmployeeID" +
                ", LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, Cit" +
                "y, Region, PostalCode, Country, HomePhone, Extension, Notes, ReportsTo FROM Empl" +
        ...
        public virtual int Update(
            ...
            if ((Original_ReportsTo.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[41].Value = ((int)(Original_ReportsTo.Value));
            }
            else {
