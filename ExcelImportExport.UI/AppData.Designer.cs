...
namespace ExcelImportExport.UI {
    ...
    public partial class AppData : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            public EmployeesRow AddEmployeesRow(
                ...
                if ((parentEmployeesRowByFK_Employees_Employees != null)) {
                    columnValuesArray[15] = parentEmployeesRowByFK_Employees_Employees[0];
                }
        ...
        public partial class EmployeesRow : global::System.Data.DataRow {
            ...
            public bool AktifMi {
                get {
                    return ((bool)(this[this.tableEmployees.AktifMiColumn]));
                }
                set {
                    this[this.tableEmployees.AktifMiColumn] = value;
                }
            }
...
namespace ExcelImportExport.UI.AppDataTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Employees] ([LastName], [FirstName], [Title], [TitleOfCourtesy], [BirthDate], [HireDate], [Address], [City], [Region], [PostalCode], [Country], [HomePhone], [Extension], [Notes], [ReportsTo], [PhotoPath], [AktifMi]) VALUES (@LastName, @FirstName, @Title, @TitleOfCourtesy, @BirthDate, @HireDate, @Address, @City, @Region, @PostalCode, @Country, @HomePhone, @Extension, @Notes, @ReportsTo, @PhotoPath, @AktifMi);
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Notes, ReportsTo, PhotoPath, AktifMi FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [Title] " +
                ...
                "on] = @Extension, [Notes] = @Notes, [ReportsTo] = @ReportsTo, [PhotoPath] = @Pho" +
                "toPath, [AktifMi] = @AktifMi WHERE (([EmployeeID] = @Original_EmployeeID) AND ([" +
                ...
                "ll_TitleOfCourtesy = 1 AND [TitleOfCourtesy] IS NULL) OR ([TitleOfCourtesy] = @O" +
                "riginal_TitleOfCourtesy)) AND ((@IsNull_BirthDate = 1 AND [BirthDate] IS NULL) O" +
                "R ([BirthDate] = @Original_BirthDate)) AND ((@IsNull_HireDate = 1 AND [HireDate]" +
                " IS NULL) OR ([HireDate] = @Original_HireDate)) AND ((@IsNull_Address = 1 AND [A" +
                "ddress] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_City = 1 AND " +
                "[City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_Region = 1 AND [Regi" +
                "on] IS NULL) OR ([Region] = @Original_Region)) AND ((@IsNull_PostalCode = 1 AND " +
                "[PostalCode] IS NULL) OR ([PostalCode] = @Original_PostalCode)) AND ((@IsNull_Co" +
                "untry = 1 AND [Country] IS NULL) OR ([Country] = @Original_Country)) AND ((@IsNu" +
                "ll_HomePhone = 1 AND [HomePhone] IS NULL) OR ([HomePhone] = @Original_HomePhone)" +
                ") AND ((@IsNull_Extension = 1 AND [Extension] IS NULL) OR ([Extension] = @Origin" +
                "al_Extension)) AND ((@IsNull_ReportsTo = 1 AND [ReportsTo] IS NULL) OR ([Reports" +
                "To] = @Original_ReportsTo)) AND ((@IsNull_PhotoPath = 1 AND [PhotoPath] IS NULL)" +
                " OR ([PhotoPath] = @Original_PhotoPath)) AND ([AktifMi] = @Original_AktifMi));\r\n" +
                "SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireD" +
                "ate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Notes, Re" +
                "portsTo, PhotoPath, AktifMi FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ExcelImportExport.UI.Properties.Settings.Default.NORTHWNDConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDa" +
                ...
                "ortsTo, PhotoPath, AktifMi FROM Employees";
        ...
        public virtual int Delete(
            ...
            this.Adapter.DeleteCommand.Parameters[29].Value = ((bool)(Original_AktifMi));
        ...
        public virtual int Insert(
            ...
            if ((PhotoPath == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[15].Value = ((string)(PhotoPath));
            }
            this.Adapter.InsertCommand.Parameters[16].Value = ((bool)(AktifMi));
        ...
        public virtual int Update(
            ...
            if ((PhotoPath == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(PhotoPath));
            }
            this.Adapter.UpdateCommand.Parameters[16].Value = ((bool)(AktifMi));
            ...
            this.Adapter.UpdateCommand.Parameters[46].Value = ((bool)(Original_AktifMi));
        ...
        public virtual int Update(
                    ...
                    string Original_PhotoPath, 
                    bool Original_AktifMi) {
            return this.Update(LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Notes, ReportsTo, PhotoPath, AktifMi, Original_EmployeeID, Original_LastName, Original_FirstName, Original_Title, Original_TitleOfCourtesy, Original_BirthDate, Original_HireDate, Original_Address, Original_City, Original_Region, Original_PostalCode, Original_Country, Original_HomePhone, Original_Extension, Original_ReportsTo, Original_PhotoPath, Original_AktifMi, Original_EmployeeID);
        }
    }
