...
namespace ExcelImportExport.UI.AppData3TableAdapters {
...
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [Title] " +
                ...
                "toPath WHERE (([EmployeeID] = @Original_EmployeeID) AND ([LastName] = @Original_" +
                "LastName) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_Title = 1 AND [T" +
                "itle] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_TitleOfCourtesy = 1" +
                " AND [TitleOfCourtesy] IS NULL) OR ([TitleOfCourtesy] = @Original_TitleOfCourtes" +
                "y)) AND ((@IsNull_BirthDate = 1 AND [BirthDate] IS NULL) OR ([BirthDate] = @Orig" +
                "inal_BirthDate)) AND ((@IsNull_HireDate = 1 AND [HireDate] IS NULL) OR ([HireDat" +
                "e] = @Original_HireDate)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([" +
                "Address] = @Original_Address)) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([C" +
                "ity] = @Original_City)) AND ((@IsNull_Region = 1 AND [Region] IS NULL) OR ([Regi" +
                "on] = @Original_Region)) AND ((@IsNull_PostalCode = 1 AND [PostalCode] IS NULL) " +
                "OR ([PostalCode] = @Original_PostalCode)) AND ((@IsNull_Country = 1 AND [Country" +
                "] IS NULL) OR ([Country] = @Original_Country)) AND ((@IsNull_HomePhone = 1 AND [" +
                "HomePhone] IS NULL) OR ([HomePhone] = @Original_HomePhone)) AND ((@IsNull_Extens" +
                "ion = 1 AND [Extension] IS NULL) OR ([Extension] = @Original_Extension)) AND ((@" +
                "IsNull_ReportsTo = 1 AND [ReportsTo] IS NULL) OR ([ReportsTo] = @Original_Report" +
                "sTo)) AND ((@IsNull_PhotoPath = 1 AND [PhotoPath] IS NULL) OR ([PhotoPath] = @Or" +
                "iginal_PhotoPath)));\r\nSELECT EmployeeID, LastName, FirstName, Title, TitleOfCour" +
                "tesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone" +
                ", Extension, Notes, ReportsTo, PhotoPath FROM Employees WHERE (EmployeeID = @Emp" +
                "loyeeID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDa" +
                ...
                "ortsTo, PhotoPath FROM Employees";
        ...
        public virtual int Fill(AppData3.EmployeesDataTable dataTable) {
        ...
        public virtual AppData3.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AppData3.EmployeesDataTable dataTable = new AppData3.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AppData3.EmployeesDataTable dataTable) {
        ...
        public virtual int Update(
            ...
            if ((Original_TitleOfCourtesy == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_TitleOfCourtesy));
            }
            if ((Original_BirthDate.HasValue == true)) {
            ...
            if ((Original_HomePhone == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[38].Value = ((string)(Original_HomePhone));
            }
            if ((Original_Extension == null)) {
            ...
            if ((Original_ReportsTo.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[42].Value = ((int)(Original_ReportsTo.Value));
            }
            else {
            ...
            if ((Original_PhotoPath == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[44].Value = ((string)(Original_PhotoPath));
            }
